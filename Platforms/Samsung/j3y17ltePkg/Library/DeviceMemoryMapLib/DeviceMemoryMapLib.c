...
gDeviceMemoryDescriptorEx[] = {
  ...
  // Register Regions
    {"Pinctrl",            0x139F0000, 0x00010000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   NS_DEVICE},
    ...
    {"RAM Partition",     0x40000000, 0x3E400000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
    {"FDT Pointer",       0x50000000, 0x00001000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
    {"UEFI FD",           0x50001000, 0x00200000, AddMem, SYS_MEM, SYS_MEM_CAP, BsCode, WRITE_BACK},
